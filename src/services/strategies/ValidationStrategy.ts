    ...
    cells.forEach((cell) => {
      ...
      if (cell.possibleSolutions.length === 1) {
        ...
        if (rowSolutionCounts[cell.rowIndex][solutionIndex] > 0) {
          throw new Error(
            `Row ${cell.rowIndex + 1} has duplicate solution for ${
              solutionIndex + 1
            }`
          );
        }
        ...
        if (columnSolutionCounts[cell.columnIndex][solutionIndex] > 0) {
          throw new Error(
            `Column ${cell.columnIndex + 1} has duplicate solution for ${
              solutionIndex + 1
            }`
          );
        }
        ...
        if (squareSolutionCounts[cell.squareIndex][solutionIndex] > 0) {
          throw new Error(
            `Square ${cell.squareIndex + 1} has duplicate solution for ${
              solutionIndex + 1
            }`
          );
        }
