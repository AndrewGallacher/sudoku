...
export class SquareHasSolutionInUniqueRowStrategy implements IStrategy {
    ...
    apply(cells: CellModel[]): CellModel[] {
        ...
        console.log('SquareHasSolutionInUniqueRowStrategy');
        ...
        for (let squareIndex = 0; squareIndex < 9; squareIndex++) {
            ...
            for (let solution = 1; solution < 10; solution++) {
                ...
                cells.forEach(cell => {
                    if (cell.squareIndex === squareIndex) {
                        ...
                        if (cell.possibleSolutions.includes(solution)) {
                            if (!rowIndicesContainingSolution.get(solution)!.includes(cell.rowIndex)) {
                ...
                solutionsThatCanAlreadyBeWorkedOut.forEach(s => { rowIndicesContainingSolution.set(s, []); });
            }
                    ...
                    cells.forEach(cell => {
                        ...
                        if (cell.rowIndex === rowIndices[0]) {
                            ...
                            if (cell.squareIndex !== squareIndex) {
                                ...
                                if (cell.possibleSolutions.includes(solution)) {
                                    // Eliminate 
                                    console.log(`Square ${squareIndex + 1} (by row) eliminates ${solution} from row ${cell.rowIndex + 1} column ${cell.columnIndex + 1}`);
